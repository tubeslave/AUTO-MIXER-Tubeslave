...
DEFAULT_RUNTIME_STATE_RULES: Dict[RuntimeState, RuntimeStateRule] = {
    ...
    RuntimeState.SILENCE_CAPTURE: RuntimeStateRule(
        ...
        {ACTION_FAMILY_GAIN, ACTION_FAMILY_TONAL_EQ, ACTION_FAMILY_FADER, ACTION_FAMILY_COMPRESSOR},
    ...
    RuntimeState.SOURCE_LEARNING: RuntimeStateRule(
        {ACTION_FAMILY_GAIN, ACTION_FAMILY_HPF, ACTION_FAMILY_TONAL_EQ, ACTION_FAMILY_COMPRESSOR, ACTION_FAMILY_FADER, ACTION_FAMILY_PAN, ACTION_FAMILY_FX, ACTION_FAMILY_FEEDBACK, ACTION_FAMILY_EMERGENCY_FADER},
        set(),
