    ...
    async def handle_client_message(self, websocket: WebSocketServerProtocol, message: str):
        try:
            ...
            # ========== Auto Compressor Commands ==========
                ...
                await self.get_auto_compressor_status(websocket, data.get("request_id"))
            elif msg_type == "get_auto_gate_status":
                await self.get_auto_gate_status(websocket, data.get("request_id"))
            elif msg_type == "get_auto_panner_status":
                await self.get_auto_panner_status(websocket, data.get("request_id"))
            elif msg_type == "get_auto_reverb_status":
                await self.get_auto_reverb_status(websocket, data.get("request_id"))
            elif msg_type == "get_auto_effects_status":
                await self.get_auto_effects_status(websocket, data.get("request_id"))
            elif msg_type == "get_cross_adaptive_eq_status":
                await self.get_cross_adaptive_eq_status(websocket, data.get("request_id"))
