...
function SettingsTab({
  ...
  onResetChannelPresets,
  onResetConnectSelection,
}) {
    ...
    <div className="settings-tab">
      <div className="module-card">
        <div className="module-actions">
          ...
          <button className="btn-sm" onClick={() => onResetChannelPresets?.()}>Сброс пресетов</button>
        </div>
        ...
        <div className="settings-body">
          ...
          {allSettings.mixer.mixerType === 'ableton' && (<>
            <div className="setting-row">
            ...
            <div className="setting-row">
              ...
              <input type="number" value={allSettings.mixer.abletonSendPort}
                onChange={e => handleChange('mixer', 'abletonSendPort', parseInt(e.target.value))}
                style={{width: '80px', padding: '4px 8px', border: '1px solid #30363d', borderRadius: '4px', background: '#0d1117', color: '#e6e6e6'}} />
            </div>
            <div className="setting-row">
              <label>Recv Port</label>
              <input type="number" value={allSettings.mixer.abletonRecvPort}
                onChange={e => handleChange('mixer', 'abletonRecvPort', parseInt(e.target.value))}
                style={{width: '80px', padding: '4px 8px', border: '1px solid #30363d', borderRadius: '4px', background: '#0d1117', color: '#e6e6e6'}} />
            </div>
            <div className="setting-row">
              <label>Channel Offset</label>
              <input type="number" min="0" value={allSettings.mixer.channelOffset || 0}
                onChange={e => handleChange('mixer', 'channelOffset', parseInt(e.target.value) || 0)}
                style={{width: '60px', padding: '4px 8px', border: '1px solid #30363d', borderRadius: '4px', background: '#0d1117', color: '#e6e6e6'}} />
            </div>
          </>)}
        </div>
